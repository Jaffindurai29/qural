            ...
            <div className='relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8'>
                            ...
                            <div key={course.id} className='w-full md:w-1/2 lg:w-1/3 shrink-0 px-4'>
                                ...
                                >
                                    ...
                                    <div className='px-2'>
                                        ...
                                        <button className='relative w-full h-[56px] flex items-center justify-center p-[8px] rounded-xl shadow-[0px_24.721px_32.257px_0px_rgba(229,0,92,0.19),0px_3.714px_4.846px_0px_rgba(229,0,92,0.15)] cursor-pointer hover:brightness-95 transition-all group overflow-hidden'>
                                            <div
                                                aria-hidden='true'
                                                className='absolute inset-0 pointer-events-none rounded-xl'
                                            >
                                                <div className='absolute bg-linear-to-b from-[#ed3543] inset-0 rounded-xl to-[#bb1f36]' />
                                                <div
                                                    className='absolute bg-size-[307.20001220703125px_307.20001220703125px] bg-top-left inset-0 mix-blend-plus-lighter opacity-40 rounded-xl'
                ...
                <div className='flex justify-center gap-6 mt-12'>
                    <button
                        ...
                        className={`w-14 h-14 rounded-full border-2 border-white/40 flex items-center justify-center transition-all ${
                            currentIndex === 0 ? 'opacity-30 cursor-not-allowed' : 'hover:bg-white/10 active:scale-95'
                        }`}
                    >
